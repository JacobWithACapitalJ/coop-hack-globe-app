...
DAT.Globe = function(container, colorFn) {
  ...
  function init() {
    ...
    uniforms["texture"].texture = THREE.ImageUtils.loadTexture(
      imgDir + "world" + ".jpg"
    );
  ...
  function createPoints() {
    ...
    this.uniforms["texture"].texture = THREE.ImageUtils.loadTexture(
      imgDir + "worldMask" + ".jpg"
    );
    this.uniforms["textureData"].texture = THREE.ImageUtils.loadTexture(
      imgDir + "worldDataSample" + ".jpg"
    );
  ...
  function addPoint(x, y, z, u, v, subgeo) {
    ...
    for (i = 0; i < point.geometry.faces.length; i++) {
      for (j = 0; j < point.geometry.faces[i].vertexNormals.length; j++) {
        ...
        point.geometry.faces[i].vertexNormals[j] = new THREE.Vector3(
          (x / 200) * len,
          (y / 200) * len,
          (z / 200) * len
        );
